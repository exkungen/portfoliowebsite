...
<div class="projecten">
    <div class="container">
        ...
        <div class="col-sm-4" >
            <a href="http://23136.hosts.ma-cloud.nl/school/p1.4/fro/opdracht_3/index.php"><img src="img/ajax-1.png" class="img-thumbnail img-responsive"></a>

        </div>
        <div class="col-sm-4">
            <h1>Ajax - Frontend</h1>
           <p>Met het vak front-end heb ik dit project gemaakt,
           het hoofddoel van dit project was om kennis te maken met AJAX.

           AJAX is heel belangrijk in de webdevelopment wereld om websites interactief te maken.
           In dit project kun je kun je verschillende dingen selecteren uit een dropdown menu.
           Zonder dat de pagina herlaad worden er resultaten weergeven.</p>
            <br>
            ...
            <br>
            <a href="https://github.com/exkungen/opdracht_3"><i class="fa fa-github"></i></a>
        </div>
