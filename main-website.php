...
<div class="projecten">
    <div class="container">
        ...
        <div class="col-sm-4" >
            ...
            <a href="http://23136.hosts.ma-cloud.nl"><img src="img/laptop.jpeg" class="img-thumbnail img-responsive"></a>
            </div>
        </div>
        <div class="col-sm-4">
            <h1>Main Website</h1>
            <p>In het eerste jaar van mijn development opleiding moest ik
            een website maken waar al mijn opdrachten in stonden</p>
            <p>En waar ik iets over mijzelf vertelde
            Ik heb veel kennis opgestoken in front-end en het was een leuke
            en leerzame leer-process</p>
            <br>
            ...
            <br>
            <a href="https://github.com/exkungen/mainwebsite"><i class="fa fa-github"></i></a>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <hr />
                    <form method="post"  action="contact_proccess.php">
